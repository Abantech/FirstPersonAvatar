...
public class KinectJointFilter
{
    ...
    Dictionary<JointType, Vector3> filteredJointPositionsMap;
    ...
    public Dictionary<JointType, Vector3> GetFilteredJointPositionsMap()
    {
        return filteredJointPositionsMap;
    }
    ...
    void UpdateJoint(Body body, JointType jt, TRANSFORM_SMOOTH_PARAMETERS smoothingParams)
    {
        ...
        filteredJointPositionsMap[jt] = new Vector3(vPredictedPosition.X, vPredictedPosition.Y, vPredictedPosition.Z);
    }
}